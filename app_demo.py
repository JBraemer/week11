...
st.subheader(f'Analysis by Jacqueline Braemer - {selected_year}')
st.write('Total expense transactions:', len(expenses))
...
monthly = monthly[monthly['date'].dt.year == selected_year]
